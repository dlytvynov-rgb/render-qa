...
ДОКАЗИ-FIRST: спершу подумки опиши, що РЕАЛЬНО видно на кропі ПІСЛЯ (об'єкт, матеріал, колір, форма), і ЛИШЕ тоді визнач вердикт. Флагуй «не зроблено» ТІЛЬКИ якщо на кропі видно, що правку НЕ застосовано. Якщо підтвердити візуально неможливо — напиши це в note й постав обережний conf, а не навмання «no».

ВІДПОВІДАЙ ТІЛЬКИ ОДНИМ JSON-обʼєктом:
{"done":"yes"|"partial"|"no"|"regressed","conf":0,"note":"що бачиш на кропі + вердикт, одне-два речення"}`;
}

...
ВАЖЛИВО про needs_human: якщо правку фізично НЕ ВИДНО на рендері — розмір у см/дюймах чи «трохи ширше/товще», тонкий фініш (матовий vs глянець), грубість/глибина затирки (grout), масштаб текстури тканини, «тепліший колір», або суб'єктивне («гармонізувати», «виправити помилки в зоні», «зменшити повторюваність») — став "done":"needs_human", а НЕ вгадуй yes/no. Краще чесно віддати на людську перевірку, ніж помилитись. Став yes або no ЛИШЕ коли зміну реально видно на кадрі.
...
ДОКАЗИ-FIRST: спершу подумки опиши, що РЕАЛЬНО видно на кропі ПІСЛЯ (об'єкт, матеріал, колір, форма), і ЛИШЕ тоді визнач вердикт. Флагуй «не зроблено» (no) ТІЛЬКИ якщо на кропі видно, що правку НЕ застосовано. Якщо підтвердити візуально неможливо (розмір у см/дюймах, тонкий фініш матовий/глянець, грубість/глибина затирки, масштаб текстури, суб'єктивна вимога) — став "done":"needs_human", а не навмання «no» чи «yes».
